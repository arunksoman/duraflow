...
Shared domain types (`User`, `Project`, `Workflow`, `Execution`, `Schedule`, `Worker`, `WorkflowMeta`, etc.) live in `src/lib/types/index.ts` and are used on both client and server.
